   ...
   public class ProductV3Service
    {
        ...
        public View_ProductV2UserItem SaveProductV2(ProductV2_Item product_item)
        {
            ...
            try
            {
                userItem = new ProductV3Repository().SaveProduct(product_item);
            }
            catch (Exception ex)
            {
                //todo log
        ...
        public View_ProductV2UserItem GetProductV2(int productId)
        {
            ...
            try
            {
                result = new ProductV3Repository().GetProductV2(productId);
            }
            catch (Exception ex)
            {
                //todo log
        ...
        public int SaveProductUser(ProductV2_User product_user)
        {
            ...
            try
            {
                userid = new ProductV3Repository().SaveProductUser(product_user);
            }
            catch (Exception ex)
            {
                userid = -1;
        ...
        public int SaveProductRenewal(ProductV2_Renewal product_renewal)
        {
            ...
            try
            {
                userid = new ProductV3Repository().SaveProductRenewal(product_renewal);
            }
            catch (Exception ex)
            {
                userid = -1;
        ...
        public int SaveProductItem(ProductV2_Item productv2_item)
        {
            ...
            try
            {
                result = new ProductV3Repository().SaveProductItem(productv2_item);
            }
            catch (Exception ex)
            {
                result = -1;
        ...
        public int Editproductitem(ProductV2_Item product_item)
        {
            ...
            try
            {
                result = new ProductV3Repository().Editproductitem(product_item);
            }
            catch (Exception ex)
            {
                result = -1;
        ...
        public int EditProductItemUserCheck(int productItemId, int UserId)
        {
            ...
            try
            {
                result = new ProductV3Repository().EditProductItemUserCheck(productItemId, UserId);
            }
            catch (Exception ex)
            {
                result = -1;
