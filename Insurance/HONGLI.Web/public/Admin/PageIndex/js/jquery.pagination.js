 ...
 (function($){
	...
	$.extend($.PaginationRenderers.defaultRenderer.prototype, {
		...
		createLink:function(page_id, current_page, appendopts){
			...
			{
			    if (appendopts.text == "下一页 <i></i>")
			    {
			        lnk = $("<a onclick='submit(99999,null)'>" + appendopts.text + "</a>")
                                        .attr('href', this.opts.link_to.replace(/__id__/, page_id));
			    }
			    else if (appendopts.text == "<i></i>上一页")
			    {
			        lnk = $("<a onclick='submit(0,null)'>" + appendopts.text + "</a>")
                                        .attr('href', this.opts.link_to.replace(/__id__/, page_id));
			    }
			    else
			    {
			        lnk = $("<a onclick='submit(" + appendopts.text + ")',null>" + appendopts.text + "</a>")
                   .attr('href', this.opts.link_to.replace(/__id__/, page_id));
			    }
